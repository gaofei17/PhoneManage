...
import com.sun.mail.util.MailSSLSocketFactory;
	...
	*/
	...
	public void send2(String phoneinf,String user,String mail_address) throws Exception {
        phinf = phoneinf;
        users = user;
	...
	*/
	...
	// 邮件的标题
	//message.setSubject(users+",你好"+"你所借"+phinf+"已归还，请知悉！");
	
	message.setSubject(users+",你有机器已归还。");
